...
autocmd BufNewFile *.pl call SetPlTitle()

func SetCTitle()
    call setline(1, "#include <stdio.h>")
    call append(line("."), "#include <stdlib.h>")
    call append(line(".")+1, "")
    call append(line(".")+2, "#define DISABLEWFORMAT // -Wformat=0")
    call append(line(".")+3, "#define GDBDEBUG       // -g")
    call append(line(".")+4, "#define die() exit(__LINE__)")
    call append(line(".")+5, "")
    call append(line(".")+6, "int main() {}")
    execute "normal! Ggt}i\n\t"
endfunc
func SetCppTitle()
